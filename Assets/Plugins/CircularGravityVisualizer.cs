...
public class CircularGravityVisualizer : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        try
        {
            ...
            //Default GUI values 
            hSliderRadius = circularGravity.radiusProperties.radius;
    ...
    void OnGUI()
    {
        ...
        toggleDrawForce = GUI.Toggle(new Rect(guiLocation.x + 315, guiLocation.y + 50, 80, 20), toggleDrawForce, "Draw Force");
